function[GEN]= PMSG_WINDING(PMSG)
% Inputs:
% PMSG: Structure Data of the PMSG
% Review: July 20yh, 2020
% Outputs:
...
if Nspp == q                      % Choose the type of winding
...
GEN.WINDING.Winding=sym;
GEN.WINDING.winding_type=A;
...
WW=strcat(W1,W2);
WD_OneLayer=WDT3;
GEN.WINDING.WDT_OneLayer=WD_OneLayer;
GEN.WINDING.DChain_OneLayer=WW;
...
WD_DoubleLayer=WDT7;
GEN.WINDING.WDT_DoubleLayer=WD_DoubleLayer;
GEN.WINDING.DChain_DoubleLayer=WW3;
else
